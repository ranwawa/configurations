...
exports.createAllowedListPluginFactory =
  exports.revertOption =
  exports.processOption =
    void 0;
...
var processOption = function (primaryOption, postcssRoot) {
  var processKey = function (primaryKey) {
    return primaryKey;
  };
  var extension = path.extname(postcssRoot.source.input.file);
  switch (extension) {
    case '.css':
      processKey = function (primaryKey) {
        return 'var(--'.concat(primaryKey, ')');
      };
      break;
    case '.scss':
    case '.sass':
  ...
  return stylelint.createPlugin(
    ...
    function (primaryOption, secondaryOptions, context) {
      return function (postcssRoot, postcssResult) {
        ...
        // 根据文件类型加工配置变量名
        var option = (0, exports.processOption)(
